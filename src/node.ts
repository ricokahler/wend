...
/** Wrapper middleware (return from a factory, e.g. `const cors = () => middleware(...)`): wrap execution (CORS, timing, logging). Declare a dependency on upstream context via the second type argument. */
